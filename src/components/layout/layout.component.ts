...
@Component({
  ...
  template: `
@if (isInitializing()) {
  <div class="fixed inset-0 flex flex-col items-center justify-center bg-gray-50 dark:bg-slate-900 z-[200] transition-opacity duration-300">
    ...
    <h2 class="text-2xl font-bold text-gray-800 dark:text-slate-200 mt-4">AJR Task Hub</h2>
    <p class="text-slate-600 dark:text-slate-400 animate-pulse">Loading your workspace...</p>
  </div>
} @else {
  <div class="bg-gray-50 dark:bg-slate-900 min-h-screen font-sans antialiased">
    <div class="relative min-h-screen md:flex">
      ...
      <div class="flex-1 flex flex-col transition-all duration-300 ease-in-out" 
           [ngClass]="{'md:ml-64': layoutService.isDesktopSidebarOpen(), 'md:ml-0': !layoutService.isDesktopSidebarOpen()}">
