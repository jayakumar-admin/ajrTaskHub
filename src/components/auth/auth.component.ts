      ...
      <form (ngSubmit)="onSubmit()" class="space-y-6">
        ...
        <div>
          ...
          <div class="mt-1 relative rounded-md shadow-sm">
            ...
            <input id="password" name="password" [type]="passwordFieldType()" [(ngModel)]="password" autocomplete="current-password" required
                   class="form-input pl-10 pr-10">
            <button type="button" (click)="togglePasswordVisibility()" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 focus:outline-none" aria-label="Toggle password visibility">
